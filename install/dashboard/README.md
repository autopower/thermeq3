...
* to get dashboard install script `wget --no-check-certificate --quiet -O /home/pi/yun-dash.sh https://raw.githubusercontent.com/autopower/thermeq3/master/install/dashboard/rpi-dash.sh;chmod +x /root/rpi-dash.sh`
* to run script `/home/pi/yun-dash.sh`
