...
* `wget --no-check-certificate --quiet -O /root/yun-dash.sh https://raw.githubusercontent.com/autopower/thermeq3/master/install/dashboard/yun-dash.sh;chmod +x /root/yun-dash.sh`
* `/root/yun-dash.sh`

## Installation instructions RPi
* `wget --no-check-certificate --quiet -O /home/pi/yun-dash.sh https://raw.githubusercontent.com/autopower/thermeq3/master/install/dashboard/rpi-dash.sh;chmod +x /root/rpi-dash.sh`
* `/home/pi/yun-dash.sh`
