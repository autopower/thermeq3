...
wget --no-check-certificate --quiet --output-document /root/nsm.py https://github.com/autopower/thermeq3/raw/master/install/nsm.py
if [ $? -ne 0 ]; then
...
wget --no-check-certificate --quiet --output-document /root/config.py https://github.com/autopower/thermeq3/raw/master/install/config.py
if [ $? -ne 0 ]; then
